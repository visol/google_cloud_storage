#
# Table structure for table 'tx_googlecloudstorage_resource'
#
CREATE TABLE tx_googlecloudstorage_resource (
  public_id text,
...
#
# Table structure for table 'tx_googlecloudstorage_folder'
#
CREATE TABLE tx_googlecloudstorage_folder (
  folder text,
