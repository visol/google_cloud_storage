    ...
    function ($className) {
        if (strpos($className, 'Visol\Cloudinary') === 0) {
            $fileNameAndPath = str_replace(
                [
                    'Visol\GoogleCloudStorage\Tests\Acceptance\\',
                    '\\',
                ],
                [
                    '',
...
/**
 * Class GcsAcceptanceTestCommand
 */
class GcsAcceptanceTestCommand extends AbstractGcsCommand
{
    /**
    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->setHelp(
                'Usage: ./vendor/bin/typo3 gcs:tests'
            );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (!$couldName || !$apiKey || !$apiSecret) {
            ...
            $message .= '"cld-name" is the name of the gcs bucket' . LF;
