...
use Visol\GoogleCloudStorage\Services\GcsScanService;

/**
 * Class CloudinaryScanCommand
 */
class GcsScanCommand extends AbstractGcsCommand
{
    ...
    /**
     * @return object|GcsScanService
     */
    protected function getCloudinaryScanService(): GcsScanService
    {
        return GeneralUtility::makeInstance(
            GcsScanService::class,
            $this->storage,
            $this->io
        );
    }
